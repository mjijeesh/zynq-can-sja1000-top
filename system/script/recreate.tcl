...
# Create project
create_project ${project_name} ${orig_proj_dir} -part xc7z010clg400-1
...
set obj [get_filesets sources_1]
set_property -name "top" -value "top_hdl" -objects $obj
...
set_property -name "steps.write_bitstream.tcl.post" -value "[file normalize "$origin_dir/../script/dist.tcl"]" -objects $obj
