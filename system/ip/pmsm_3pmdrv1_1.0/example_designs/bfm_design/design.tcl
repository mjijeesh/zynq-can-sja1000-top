proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: pmsm_3pmdrv1_0, and set properties
	set pmsm_3pmdrv1_0 [ create_bd_cell -type ip -vlnv user.org:user:pmsm_3pmdrv1:1.0 pmsm_3pmdrv1_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins pmsm_3pmdrv1_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins pmsm_3pmdrv1_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins pmsm_3pmdrv1_0/S00_AXI_ARESETN]
	...
	# Create interface connections
	connect_bd_intf_net [get_bd_intf_pins master_1/M_AXI_LITE] [get_bd_intf_pins pmsm_3pmdrv1_0/S_AXI_INTR]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_1/M_AXI_LITE_ACLK] [get_bd_pins pmsm_3pmdrv1_0/S_AXI_INTR_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_1/M_AXI_LITE_ARESETN] [get_bd_pins pmsm_3pmdrv1_0/S_AXI_INTR_ARESETN]
	set S_AXI_INTR_IRQ [ create_bd_port -dir O -type intr irq ]
	connect_bd_net [get_bd_pins /pmsm_3pmdrv1_0/irq] ${S_AXI_INTR_IRQ}
	...
	set offset_file "${bd_path}/pmsm_3pmdrv1_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef pmsm_3pmdrv1_v1_0_tb_include_vh_"
	puts $fp "`define pmsm_3pmdrv1_v1_0_tb_include_vh_\n"
	...
	set param_irq_active_state [get_property CONFIG.C_IRQ_ACTIVE_STATE [get_bd_cells pmsm_3pmdrv1_0]]
	set param_irq_sensitivity [get_property CONFIG.C_IRQ_SENSITIVITY [get_bd_cells pmsm_3pmdrv1_0]]
	set param_intr_active_state [get_property CONFIG.C_INTR_ACTIVE_STATE [get_bd_cells pmsm_3pmdrv1_0]]
	set param_intr_sensitivity [get_property CONFIG.C_INTR_SENSITIVITY [get_bd_cells pmsm_3pmdrv1_0]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:pmsm_3pmdrv1:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/pmsm_3pmdrv1_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "pmsm_3pmdrv1_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 pmsm_3pmdrv1_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top pmsm_3pmdrv1_v1_0_tb [get_filesets sim_1]
